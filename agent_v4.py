...
BASE_SYSTEM_PROMPT = (
    ...
    "indexed documents — prefer this over cat for large files or open-ended questions. "
...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "search",
            "description": "Exact keyword search (case-insensitive substring match). Use this ONLY when looking for a specific known string. For any question, topic, or concept — use rag_search instead.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    # ── NEW in v4 ─────────────────────────────────────────────────────────────
    {
        ...
        "function": {
            "name": "rag_search",
            "description": (
                "Semantically search indexed documents using vector similarity. "
                "Use this as the DEFAULT tool for any question about workspace content, topics, or concepts. "
                "Returns the most relevant text chunks with their source file. "
                "Prefer this over 'search' and 'cat' for any open-ended or conceptual query. "
